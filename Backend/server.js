  ...
  try {
    ...
    try {
      await sequelize.query(
        'ALTER TABLE "favorites" DROP CONSTRAINT IF EXISTS "favorites_placeId_fkey" CASCADE;',
      );
      await sequelize.query(
        'ALTER TABLE "histories" DROP CONSTRAINT IF EXISTS "histories_placeId_fkey" CASCADE;',
      );
    } catch (e) {
